...
public:
    ...
    Frame(uint32 id, double translationx, double translationy, double rotation, double scalex, double scaley);
...
inline Frame::Frame(uint32 id, double translationx, double translationy, double rotation, double scalex, double scaley)
    : id(id),
