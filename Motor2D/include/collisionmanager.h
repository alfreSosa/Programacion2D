...
public:
  ...
  virtual bool CircleToPixels(double cx, double cy, double cr, const CollisionPixelData * pixels, double px, double py) const { return false; };
  virtual bool CircleToRect(double cx, double cy, double cr, double rx, double ry, double rw, double rh) const;
  virtual bool PixelToPixel(const CollisionPixelData *p1, double x1, double y1, const CollisionPixelData *p2, double x2, double y2) const { return false; };
  virtual bool PixelsToRect(const CollisionPixelData *pixels, double px, double py, double rx, double ry, double rw, double rh) const { return false; };
